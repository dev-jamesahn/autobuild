...
ENV_MAIL_TO_SET=0
ENV_REPORT_SUBJECT_PREFIX_SET=0
if [ "${MAIL_TO+x}" = "x" ]; then
    ENV_MAIL_TO_SET=1
    ENV_MAIL_TO="$MAIL_TO"
fi
if [ "${REPORT_SUBJECT_PREFIX+x}" = "x" ]; then
    ENV_REPORT_SUBJECT_PREFIX_SET=1
    ENV_REPORT_SUBJECT_PREFIX="$REPORT_SUBJECT_PREFIX"
fi
...
if [ "$ENV_MAIL_TO_SET" = "1" ]; then
    MAIL_TO="$ENV_MAIL_TO"
fi
if [ "$ENV_REPORT_SUBJECT_PREFIX_SET" = "1" ]; then
    REPORT_SUBJECT_PREFIX="$ENV_REPORT_SUBJECT_PREFIX"
fi
