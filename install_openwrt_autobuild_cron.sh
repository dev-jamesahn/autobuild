...
GDM7243A_UTKERNEL_CRON_LINE="3 0 * * * CONFIG_FILE=$GDM7243A_UTKERNEL_CONFIG /bin/bash -lc '$OS_SCRIPT_PATH >> \"$GDM7243A_UTKERNEL_CRON_LOG\" 2>&1' $GDM7243A_UTKERNEL_CRON_TAG"
GDM7243ST_UTKERNEL_CRON_LINE="4 0 * * * CONFIG_FILE=$GDM7243ST_UTKERNEL_CONFIG /bin/bash -lc '$OS_SCRIPT_PATH >> \"$GDM7243ST_UTKERNEL_CRON_LOG\" 2>&1' $GDM7243ST_UTKERNEL_CRON_TAG"
GDM7243I_ZEPHYR_CRON_LINE="5 0 * * * CONFIG_FILE=$GDM7243I_ZEPHYR_CONFIG /bin/bash -lc '$OS_SCRIPT_PATH >> \"$GDM7243I_ZEPHYR_CRON_LOG\" 2>&1' $GDM7243I_ZEPHYR_CRON_TAG"
...
crontab -l 2>/dev/null | grep -Ev 'OPENWRT_V100_AUTOBUILD|OPENWRT_AUTOBUILD_V100|OPENWRT_AUTOBUILD_MASTER|ZEPHYROS_AUTOBUILD|GDM7243A_UTKERNEL_AUTOBUILD|GDM7243ST_UTKERNEL_AUTOBUILD|GDM7243I_ZEPHYR_V2_3_AUTOBUILD|DAILY_AUTOBUILD_MAIL_NOTIFIER' > "$TMP_CRON" || true
